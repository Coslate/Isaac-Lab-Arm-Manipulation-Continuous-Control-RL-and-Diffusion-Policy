...
def run_td3_train_loop(
    ...
    *,
    ...
    progress: Any | None = None,
    checkpoint_saver: Callable[[TD3Agent, int, dict[str, float], dict[str, Any]], None] | None = None,
) -> TD3TrainLoopReport:
...
def _maybe_save_checkpoint(
    checkpoint_saver: Callable[[TD3Agent, int, dict[str, float], dict[str, Any]], None] | None,
    agent: TD3Agent,
    env_steps: int,
    metrics: dict[str, float],
    schedulers: Mapping[str, LearningRateScheduler] | None,

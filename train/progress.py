...
class TrainProgressReporter:
    ...
    _DISPLAY_KEYS: tuple[tuple[str, str], ...] = (
        ...
        ("train/lr_restart_count", "lr_restart_count"),
        ("train/lr_updates_since_restart", "lr_updates_since_restart"),
        ("train/lr_last_restart_stage", "lr_last_restart_stage"),
        ...
        ("reward/train/grasp_like_proxy", "reward_train_grasp_like"),
        ("reward/train/tiny_lift_delta_proxy", "reward_train_tiny_lift_delta"),
        ("reward/train/target_progress_proxy", "reward_train_target_progress"),
        ("reward/train/target_funnel_proximity", "reward_train_target_funnel_proximity"),
        ("reward/train/target_funnel_progress", "reward_train_target_funnel_progress"),
        ("reward/train/target_funnel_band_bonus", "reward_train_target_funnel_band"),
        ("reward/train/target_dwell_proxy", "reward_train_target_dwell"),
        ("reward/train/target_overlift_penalty", "reward_train_target_overlift"),
        ("reward/train/target_success_bonus", "reward_train_target_success"),
        ("reward/train/target_away_penalty", "reward_train_target_away"),
        ("reward/train/near_target_action_penalty", "reward_train_near_target_action"),
        ("reward/train/target_z_alignment_penalty", "reward_train_target_z"),
        ...
        ("reward/eval_rollout/grasp_like_proxy", "reward_eval_grasp_like"),
        ("reward/eval_rollout/tiny_lift_delta_proxy", "reward_eval_tiny_lift_delta"),
        ("reward/eval_rollout/target_progress_proxy", "reward_eval_target_progress"),
        ("reward/eval_rollout/target_funnel_proximity", "reward_eval_target_funnel_proximity"),
        ("reward/eval_rollout/target_funnel_progress", "reward_eval_target_funnel_progress"),
        ("reward/eval_rollout/target_funnel_band_bonus", "reward_eval_target_funnel_band"),
        ("reward/eval_rollout/target_dwell_proxy", "reward_eval_target_dwell"),
        ("reward/eval_rollout/target_overlift_penalty", "reward_eval_target_overlift"),
        ("reward/eval_rollout/target_success_bonus", "reward_eval_target_success"),
        ("reward/eval_rollout/target_away_penalty", "reward_eval_target_away"),
        ("reward/eval_rollout/near_target_action_penalty", "reward_eval_near_target_action"),
        ("reward/eval_rollout/target_z_alignment_penalty", "reward_eval_target_z"),
        ...
        ("curriculum/gate/eval_blocked_grasp_episode_rate", "gate_eval_blocked_grasp"),
        ("curriculum/gate/eval_target_approach_episode_rate", "gate_eval_target_approach"),
        ...
        ("action/train/finger_width_p50_m", "train_finger_p50_m"),
        ("action/train/finger_width_blocked_score", "train_finger_blocked"),
        (
            "action/train/close_near_cube_finger_width_empty_closed_rate",
            "train_close_near_empty",
        ),
        ...
        ("action/eval_rollout/finger_width_p50_m", "eval_finger_p50_m"),
        (
            "action/eval_rollout/close_near_cube_finger_width_blocked_score",
            "eval_close_near_blocked",
        ),
        ...
        ("priority_replay/bucket_count/target_20cm", "bucket_target_20cm"),
        ("priority_replay/bucket_count/target_10cm", "bucket_target_10cm"),
        ("priority_replay/bucket_count/target_5cm", "bucket_target_5cm"),
        ("priority_replay/bucket_count/target_2cm", "bucket_target_2cm"),
        ("priority_replay/bucket_rarity/target_20cm", "rarity_target_20cm"),
        ("priority_replay/bucket_rarity/target_10cm", "rarity_target_10cm"),
        ("priority_replay/bucket_rarity/target_5cm", "rarity_target_5cm"),
        ("priority_replay/bucket_rarity/target_2cm", "rarity_target_2cm"),
        ...
        ("train_rollout/target_success_step_rate", "train_target_success_step"),
        ("train_rollout/target_hold_episode_rate", "train_target_hold"),
        ("train_rollout/target_20cm_episode_rate", "train_target_20cm"),
        ("train_rollout/target_10cm_episode_rate", "train_target_10cm"),
        ("train_rollout/target_5cm_episode_rate", "train_target_5cm"),
        ("train_rollout/target_2cm_episode_rate", "train_target_2cm"),
        ("train_rollout/p50_cube_to_target_m", "train_p50_cube_target_m"),
        ("train_rollout/mean_action_jerk", "train_rollout_jerk"),
        ...
        ("eval/target_success_step_rate", "eval_target_success_step"),
        ("eval/target_hold_episode_rate", "eval_target_hold"),
        ("eval/target_20cm_episode_rate", "eval_target_20cm"),
        ("eval/target_10cm_episode_rate", "eval_target_10cm"),
        ("eval/target_5cm_episode_rate", "eval_target_5cm"),
        ("eval/target_2cm_episode_rate", "eval_target_2cm"),
        ("eval/p50_cube_to_target_m", "eval_p50_cube_target_m"),
        ...
        ("eval_rollout/target_success_step_rate", "eval_target_success_step"),
        ("eval_rollout/target_hold_episode_rate", "eval_target_hold"),
        ("eval_rollout/target_20cm_episode_rate", "eval_target_20cm"),
        ("eval_rollout/target_10cm_episode_rate", "eval_target_10cm"),
        ("eval_rollout/target_5cm_episode_rate", "eval_target_5cm"),
        ("eval_rollout/target_2cm_episode_rate", "eval_target_2cm"),
        ("eval_rollout/target_hold_max_consecutive_steps", "eval_target_hold_steps"),
        ("eval_rollout/mean_cube_to_target_m", "eval_mean_cube_target_m"),
        ("eval_rollout/p50_cube_to_target_m", "eval_p50_cube_target_m"),
        ("eval_rollout/final_cube_to_target_m", "eval_final_cube_target_m"),
        ("eval_rollout/mean_action_jerk", "eval_rollout_jerk"),
